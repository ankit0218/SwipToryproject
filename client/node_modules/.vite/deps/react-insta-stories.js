            ...
            544: (
              ...
              function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var renderer = function renderer2(_ref) {
                  ...
                  var _React$useState = React.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), loaded = _React$useState2[0], setLoaded = _React$useState2[1];
                  var _React$useState3 = React.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), muted = _React$useState4[0], setMuted = _React$useState4[1];
                  var width = config.width, height = config.height, loader = config.loader, storyStyles = config.storyStyles;
                  var computedStyles = Object.assign(Object.assign({}, styles.storyContent), storyStyles || {});
            ...
            402: (
              ...
              function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var shouldPreload = function shouldPreload2(content) {
                  if (!content.url)
                    return false;
                  if (urlsLoaded.has(content.url))
                    return false;
                  if (content.preloadResource !== void 0)
                    return content.preloadResource;
                  if (content.type === "video")
                    return false;
                  return true;
                };
